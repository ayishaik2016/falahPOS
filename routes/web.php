...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('client')->group(function () {
        Route::get('/list', [ClientController::class, 'list'])->name('client.view');
        ...
        Route::get('/datatable', [ClientController::class, 'datatableList'])->name('client.datatableList');
        });

        // ----------------------------------------------------------------
        // STORE routes — nested under a client
        // ----------------------------------------------------------------
        Route::prefix('store')->name('store.')->group(function () {
        // List all stores for a specific client
        Route::get('/list/{client_id}', [StoreController::class, 'list'])->name('list');

        // CRUD
        Route::get('/create/{client_id}', [StoreController::class, 'create'])->name('create');
        ...
        // DataTable AJAX
        Route::get('/datatable/{client_id}', [StoreController::class, 'datatableList'])->name('datatableList');

        // Switch active store (used by StoreSwitcher component)
        Route::get('/switch/{store_id}', [StoreController::class, 'switchStore'])->name('switch');
        });
