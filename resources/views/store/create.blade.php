                ...
                <div class="col-12 col-lg-12">
                    <div class="card">
                        <div class="card-header px-4 py-3">
                            <h5 class="mb-0">{{ __('app.add_store') }} — {{ $client->first_name }} {{ $client->last_name }}</h5>
                        </div>
                        <div class="card-body p-4">
                            <form class="row g-3 needs-validation" id="storeForm" action="{{ route('store.store') }}" enctype="multipart/form-data">
                                {{-- CSRF Protection --}}
                                @csrf
                                @method('POST')
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="code" class="form-control" placeholder="e.g. STR-001" required>
                                    </div>
                                    <div class="col-md-3">
